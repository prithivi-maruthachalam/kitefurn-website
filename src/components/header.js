    ...
    return (
      <div className="header-container header-padding">
        <div className="flex-container">
          ...
          <div>
            {/* Logo (Home) Button */}
            <Link to="/"> <button className="header-btn btn-logo" /> </Link>
          </div>
          ...
          <div>
            {/* Home Button */}
            <HashLink to="/">
              <button className="header-btn header-nav-btn btn-nav">
                <img
            ...
            {/* Residence Interiors Button */}
            <HashLink to="/customInteriors#residence">
              <button className="header-btn header-nav-btn btn-nav"> Residence Interiors </button>
            </HashLink>

            {/* External link to kite furn */}
            <a href="http://www.kitekitchens.com/" className="resp-block">
              <button className="header-btn header-nav-btn btn-nav"> Modular Kitchens </button>
            </a>

            {/* Collapsible Menu for Custom Interiors */}
          </div>
          ...
          <div>
                <div className="phn-container">
                 <PhoneButton
                   ...
                   alt={content.phA.alt}
                   className="header-btn call-btn-pad call-btn-A"
                 />
               </div>
               ...
               <a href="https:goo.gl/maps/u4nzcxS5XatMFXyA7" target="_blank">
                 <button className="header-btn map-button">
                   <img
                     src={mapIcon}
                     alt={content.map.alt}
                     className="top-btn-img-home hover-shake"
                   />
                 </button>
               </a>
          </div>
...
//           <button
//             className="header-button-base btn-nav"
